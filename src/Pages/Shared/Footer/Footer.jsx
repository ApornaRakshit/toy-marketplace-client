...
const Footer = () => {
    ...
    return (
        <footer>
            <div className="footer p-10 bg-[#38a09b] text-neutral-content">
                <div>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li><Link className='hover:link' to="/">Charity</Link></li>
            ...
            <div className="footer footer-center p-4  bg-[#38a09b] text-white">
                    <div>
                        <p>Copyright <span className='copyright'>&#169;</span> {year} - All right reserved by Toy-Mart Industries Ltd</p>
                    </div>
                </div>
        </footer>
    );
